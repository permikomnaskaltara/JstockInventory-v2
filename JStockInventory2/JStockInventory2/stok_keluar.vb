...
Public Class stok_keluar
    ...
    Private Sub stok_keluar_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Dim methodName As String = System.Reflection.MethodBase.GetCurrentMethod().Name
        Try
            do_autofill = 1
            Call set_init_dgview()
            combo_penjualan.SelectedIndex = 0
            If data_obj.con_mysql.State = ConnectionState.Closed Then
                data_obj.mysql_connect()
            End If
    ...
    Private Sub tombol_simpan_Click(sender As Object, e As EventArgs) Handles tombol_simpan.Click
        ...
        Try
            ...
            Dim datareader_mysql_local As MySqlDataReader
            datareader_mysql_local = Nothing
            count_row = 0
            ...
            ElseIf Len(text_jumlah_keluar.Text) < 1 Then
                MsgBox("jumlah keluar harus diisi !")
            ...
            Else
                ...
                Dim stok_keluar_str As String
                Dim stok_keluar_int As Integer
                ...
                stok_keluar_str = text_jumlah_keluar.Text.Replace(",", "")
                id = text_id.Text
                ...
                If count_row > 0 Then
                    ...
                    stok = datareader_mysql_local(7).ToString
                    stok_int = Val(stok)
                    stok_keluar_int = Val(stok_keluar_str)
                    new_stok = stok_int - stok_keluar_int
                    If new_stok < 0 Then
                        MsgBox("Jumlah stok tersisa " + stok + ", silahkan input jumlah keluar lebih kecil dari jumlah stok : " + stok)
                    Else
                        Dim ret = 0
                ...
                Else
                    failure_mark = 1
                    MsgBox("Data barang tidak ditemukan di database ! untuk menginput jenis barang baru, gunakan tombol stok masuk")
                End If
                ...
                If failure_mark = 0 Then
                    ...
                    If combo_penjualan.Text = "ya" Then
                        mark = "penjualan"
                    End If
                    ...
                    Dim sql_penjualan = "INSERT INTO `op_stok_keluar` (`id`, `kode`,  `nama_produk`, `harga`, `jumlah`, `waktu`, `tanggal`, `bulan`, `tahun`,`mark`,`full_date`) VALUES (NULL, '" + kode + "', '" + nama_produk + "', '" + harga + "', '" + stok_keluar_str + "', '" + waktu + "', '" + tanggal + "', '" + bulan + "', '" + tahun + "','" + mark + "', '" + full_date + "');"
                    Try
                        data_obj.mysql_just_exec(sql_penjualan)
                    Catch ex As Exception
                        Console.WriteLine(ex.ToString)
                    End Try
                    ...
                    If combo_masuk_kas.Text = "ya" Then
                        ...
                        Dim id_pembelian_atau_penjualan = data_obj.ret_colval_string_from_colval("op_stok_keluar", "mark", "penjualan", "id")
    ...
    Private Sub text_jumlah_keluar_TextChanged(sender As Object, e As EventArgs) Handles text_jumlah_keluar.TextChanged
        Try
            If Len(text_harga.Text) > 0 Then
                Dim nilai_masuk As Integer
                Dim nilai_harga As Integer
                Dim nilai_subtotal As Integer
                nilai_masuk = Val(text_jumlah_keluar.Text.Replace(".", "").Replace(",", ""))
            ...
            Dim fmt As String
                fmt = data_obj.format_num(text_jumlah_keluar.Text)
                text_jumlah_keluar.Text = fmt
                text_jumlah_keluar.SelectionStart = Len(text_jumlah_keluar.Text)
        Catch ex As Exception
            MsgBox(ex.ToString)
        End Try
    End Sub
    ...
    Private Sub tombol_delete_all_Click(sender As Object, e As EventArgs) Handles tombol_delete_all.Click
        Dim methodName As String = System.Reflection.MethodBase.GetCurrentMethod().Name
        Try
            Dim hapus = basic_op.konfirmasi_hapus("Apakah Anda yakin untuk menghapus seluruh data stok keluar ?", "Hapus Data Seluruh Stok Keluar")
            If hapus = 1 Then
                form_delete_all.table_name = "op_stok_keluar"
