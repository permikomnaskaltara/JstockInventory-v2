...
Public Class form_utama
    ...
    Private Sub MasterDataKasToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles MasterDataKasToolStripMenuItem.Click
        ...
        basic_op.setfokus(form_master_data_kas)
    End Sub
    ...
    Private Sub MasterDataStokToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles MasterDataStokToolStripMenuItem.Click
        stok.Show()
        basic_op.setfokus(stok)
    End Sub

    Private Sub KosongkanResetSeluruhDatabaseToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles KosongkanResetSeluruhDatabaseToolStripMenuItem.Click
        form_empty.Show()
        basic_op.setfokus(form_empty)
    End Sub
End Class